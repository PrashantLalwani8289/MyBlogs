...
const RecentPost = ({ blogs }) => {
  ...
  return (
    <section className="w-full m-16 px-32 flex flex-col items-center justify-center">
      ...
      <div className="grid grid-cols-3 grid-rows-2 gap-16 mt-16">
        {
            sortedBlogs.slice(5,11).map((blog, index) => {
                return <article className="col-span-1 row-span-1 relative" key={index}><BlogLayoutThree blog={blog}></BlogLayoutThree></article>
            })
        }
